...
INC_TEST_SUITE := -I$(SRC_TEST_SUITE) -I$(ROOT)/libraries/includes -I$(ROOT)/sources
...
test_suite: $(OBJ_TEST_SUITE)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -o $(BINARIES)/test_suite $(LIB)/gtest.o $(LIB)/gtest_main.o $(OBJ_TEST_SUITE) -L$(BINARIES) -l:support.so -pthread
